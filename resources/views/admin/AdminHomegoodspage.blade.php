...
<head>
    ...
    <title>Admin_Homegoods_Page</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="../../assets/styles/admin_styles.css"/>
    <link rel="stylesheet" href="../../assets/styles/admin_responsive.css"/>
</head>
...
<div class="sidebar">
    <div class="sidebar_container1">
        ...
        <div class="sidebar_menu_block">
            ...
            <a href="AdminAllProducts.html" class="sidebar_menu_block_item">All Products</a>
            <hr class="line_admin_dashboard">
            <a href="AdminMyProducts.html" class="sidebar_menu_block_item">My Products</a>
            <hr class="line_admin_dashboard">
            <a href="AdminNotifications.html" class="sidebar_menu_block_item">Notifications</a>
            <hr class="line_admin_dashboard">
...
<div class="Admin_homeGoods_section1">
    <img src="../../assets/images/Homegoods.png" alt="" class="admin_categories_img">
    ...
    <div class="homeGoods_section2_1">
        ...
        <div class="filtered_category">
            ...
            <div class="panel">
                ...
                <div class="admin_new_category_panel">
                    <img src="../../assets/images/plus_admin_panel.png" alt="" class="accordion_plus myBtn_sub">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content_section1">
                ...
                <div class="modal_title_block">
                    <div CLASS="modal_title_block-inner">
                        ...
                        <p class="link_site"><a href="https://www.dealigg.com/" target="_blank">Visit Site</a></p>
                    </div>
                </div>
            </div>
            <div class="cancel_ok">
        ...
        <div class="modal_content_all">
            <div class="modal-content_accordion">
                ...
                <div class="admin_new_category_panel_modal">
                    <input type="number"class="sale_discount_input">
                    <input type="number" class="sale_discount_input1">
                </div>
            </div>
    ...
    <div class="modal-content_accordion_modal">
        <div class="modal_content_all">
            <div class="modal-content_accordion">
                <span class=""></span>
                <div class="admin_new_category_panel_modal">
                    <input type="text"class="subCategory_input">
