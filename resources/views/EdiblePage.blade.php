...
<body>
<input type="number" id="categoryId" value="3" style="display: none" disabled>
@include('layouts/navigation')


<div class="homeGoods_section1">
    <img src="{{asset('images/Endible.png')}}" alt="" class="face_page_pic">
    <span class="homeGoods_title">Edibles</span>
</div>
