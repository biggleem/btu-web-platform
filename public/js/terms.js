...
let inputsapp = document.getElementsByClassName('Terms_Policy_inner')[0];

function createInputs(element){
    inputsapp.innerHTML+='<div class="Terms_Policy_Block_">\n' +
        '                <div class="Terms_Policy_Block">\n' +
        '                    <label class="faqs_label_question">Section<a id="count">'+(inputsapp.children.length+1)+'</a></label>\n' +
